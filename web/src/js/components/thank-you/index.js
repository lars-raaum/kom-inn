    ...
    renderHost() {
        ...
        return (
            <div>
                ...
                <p>{translate("Vi vil prøve å finne noen du kan invitere på middag så fort så mulig. Når vi har funnet passende gjester - hører du fra oss!")}</p>
                <p>{translate("Noen ganger går det noen dager, andre ganger bruker vi flere uker. Dette kan variere veldig. Vi forsøker så godt vi kan å finne rett match så opplevelsen for begge parter skal bli best mulig. Hvis du synes det går for lang tid er det lov å sende oss en mail.")}</p>
                <p>{translate("For deg som bor utenfor Oslo : <i>Kom inn</i> er enda ikke etablert over hele landet. Vi håper å få til dette i løpet av ikke så lang tid. Vi tar kontakt med deg når vi har gjester i ditt området!")}</p>
                ...
                <p className="fb-share-button" data-href="https://www.facebook.com/" data-layout="button" data-size="small" data-mobile-iframe="false"><a className="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.facebook.com%2F&amp;src=sdkpreparse">{this.context.translate('Del på Facebook')}</a></p>
    ...
    render() {
        ...
        return <div className="mdl-grid">
            <div className="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--2dp">
                <div className="mdl-card__title">{this.context.translate("Takk")}</div>
