...
class Purge
{
    ...
    public function buildReactivateUsedHostText(array $host) : string
    {
        ...
        <p>Hvis du ikke trykker på en link antar vi at du ikke lenger er interessert og vi vil slette dine opplysninger.</p>
        <p>mvh<br>\n
        Kom inn<br>\n
    ...
    public function buildExpiredHostText(array $host) : string
    {
        ...
        <p>Hvis du ikke trykker på linken antar vi at du ikke lenger er interessert og vi vil slette dine opplysninger.</p>\n
