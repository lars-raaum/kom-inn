...
class Matches implements \Pimple\ServiceProviderInterface
{
    ...
    public function insert(array $data)
    {
        ...
        $this->app['monolog']->info("INSERT match Guest[{$data['guest_id']}] Host[{$data['host_id']}] by [{$this->app['PHP_AUTH_USER']}]");
    ...
    public function update(int $id, array $data) : bool
    {
        ...
        $this->app['monolog']->info("UPDATE Match[{$id}] by [{$this->app['PHP_AUTH_USER']}]");
    ...
    public function delete(int $id) : bool
    {
        ...
        $this->app['monolog']->info("SOFT DELETE Match[{$id}] by [{$this->app['PHP_AUTH_USER']}]");
        $result = $this->app['db']->update('matches', $data, ['id' => $id], $types);
        if (!$result) {
